	...
	public static void processCaseA() {
		...
		{    
			...
			System.out.println("The corresponding ASCII is " + myascii);
				...
				System.out.println("Your input the number is not printable, but its nearest printable character is 'space'.");
		else if (real_num_part == 127)
			System.out.println("Your input the number is not printable, but its nearest printable character is '~'.");
		else 
